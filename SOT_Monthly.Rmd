...
For the purpose of this notebook, we will not query the database however. Instead, we will load objects already created and stored on an FTP site on the corporate network.  
```{r echo=FALSE}
